        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldeCredit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Telephone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConditionsPaiement = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoldeDette = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeBarres = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ...
                    TvaPct = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrixOverride = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHT = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalTTC = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    RemiseGlobale = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ModePaiement = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MontantRecu = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MonnaieRendue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Statut = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrixAchatUnitaire = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantite = table.Column<int>(type: "int", nullable: false),
                    PrixUnitaire = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    RemisePct = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    SousTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Nom", "Permissions" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "SuperAdmin", "[\"*\"]" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "Admin", "[\"products\",\"stock\",\"sales\",\"clients\",\"orders\",\"reports\",\"suppliers\"]" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Caissier", "[\"pos\",\"stock.read\",\"orders.read\"]" },
                    { new Guid("44444444-4444-4444-4444-444444444444"), "Vendeur", "[\"products.read\",\"pos\"]" },
                    { new Guid("55555555-5555-5555-5555-555555555555"), "Client", "[\"orders.own\",\"profile\"]" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CodeBarres",
                table: "Products",
                column: "CodeBarres",
                unique: true,
                filter: "[CodeBarres] IS NOT NULL");
